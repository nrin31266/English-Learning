...
import { LogOut, User, LifeBuoy, MessageSquare, Github, ChevronDown, LogIn } from "lucide-react"
  ...
  if (!profile) {
    return (
      <Button 
        ...
        variant="default" 
        size="sm" 
        className="h-9 px-4 rounded-lg font-bold gap-2 shadow-md shadow-primary/20 transition-transform active:scale-95"
      >
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="ghost" 
          className="relative h-9 flex items-center gap-2 rounded-lg pl-2 pr-2.5 hover:bg-muted/60 transition-colors focus-visible:ring-1 focus-visible:ring-primary/50 data-[state=open]:bg-muted/60"
        >
          ...
          <span className="hidden sm:flex items-center gap-1.5">
            ...
            {/* Hiệu ứng xoay mũi tên tự động nhờ group-hover hoặc trạng thái data-state */}
